            ...
            <CardContent className="p-4">
              <div className="flex justify-between">
                ...
                <div className="flex justify-end items-center gap-4">
                  <Button onClick={() => sendCommand('put', group.id, '/ai/workmode', {mode: "humanTrackingSingleMode"})}>Start Tracking</Button>
                  <Button onClick={() => sendCommand('put',group.id, '/ai/workmode', {mode: "none"})}>Stop Tracking</Button>
                  <Button onClick={() => sendCommand('put', group.id, '/ptz/preset', { operation: "call", id: 0})}>Reset position</Button>
                </div>
              </div>
                  ...
                  cameras.filter(c => c.groupId === group.id).map(cam => (
                    <div key={cam.id} className="border-0 bg-neutral-800 rounded p-2">
                      ...
                      <div className="flex justify-end space-x-2 mt-2">
                        ...
                        <Button onClick={() => sendSingleCommand('put', cam, '/ptz/preset', { operation: "call", id: 0}) }>
                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
